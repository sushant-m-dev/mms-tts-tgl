...
class TextToSpeechStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ConvertTextToSpeech = channel.unary_unary(
                ...
                request_serializer=tts__pb2.TextRequest.SerializeToString,
...
def add_TextToSpeechServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ConvertTextToSpeech': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=tts__pb2.TextRequest.FromString,
...
class TextToSpeech(object):
    ...
    def ConvertTextToSpeech(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/TextToSpeech/ConvertTextToSpeech',
            tts__pb2.TextRequest.SerializeToString,
